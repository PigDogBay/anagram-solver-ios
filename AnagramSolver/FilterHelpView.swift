...
struct FilterHelpView: View {
    var body: some View {
        Form {
            ...
            Text("To reduce the number of matches you can add extra search criteria. First enter your query and perform a search, next press the Filter button, you will be taken to the filters screen. Set up your filters and press the Search button, the app will go back to the results screen and perform the search again and apply filters you have set.\n\nTip! Going back to the main screen will disable the filters. You can edit the main query from the filters screen to save time.")
                .padding(8)
